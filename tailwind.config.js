...
export default {
  ...
  plugins: [],
  safelist: [
    // Add any classes that might be dynamically generated and need to be included in the build
    {
    ...
    {
      pattern: /border-(red|green|blue|yellow|purple|pink|indigo|gray)-(100|200|300|400|500|600|700|800|900)/,
      variants: ['hover', 'focus', 'dark'],
    },
  ],
};