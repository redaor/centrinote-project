/**
 * Edge Function pour transcrire l'audio uploadé via OpenAI Whisper API
 * Utilisé pour les enregistrements de cours longs (chunks)
 * Utilise OPENAI_API_KEY depuis les secrets Supabase
