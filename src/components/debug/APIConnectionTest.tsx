    ...
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg">
        ...
        <ul className="text-sm text-blue-700 space-y-1">
          <li><strong>API Base:</strong> {import.meta.env.VITE_API_BASE || (import.meta.env.PROD ? '/.netlify/functions' : 'http://localhost:8888/.netlify/functions')}</li>
          <li><strong>Backend URL (legacy):</strong> {import.meta.env.VITE_BACKEND_URL || 'N/A'}</li>
