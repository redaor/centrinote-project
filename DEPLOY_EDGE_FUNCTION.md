# 🚀 Déploiement Edge Function log-error

## Code à copier dans le Dashboard Supabase

Allez sur : https://supabase.com/dashboard/project/wjzlicokhxitmeoxkjzv/functions/log-error
...
**Résultat attendu :** `200 OK` avec headers CORS présents.
